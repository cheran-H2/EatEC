...
const seedDatabase = async () => {
    try {
        ...
        console.log("Copying images from frontend/src/assets to backend/uploads...");

        let copiedCount = 0;
        for (let i = 1; i <= 32; i++) {
            const imageName = `food_${i}.png`;
        ...
        console.log(`Copied ${copiedCount} images successfully.`);

        console.log("Seeding database food items...");
        let insertedCount = 0;
        ...
        console.log(`Database seeding completed! Successfully inserted ${insertedCount} new food items.`);
        process.exit(0);
    } catch (error) {
